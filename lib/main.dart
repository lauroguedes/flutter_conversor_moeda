...
const request = 'https://api.hgbrasil.com/finance?format=json&key=dd2f8702';

void main() async {
  runApp(MaterialApp(
    home: Home(),
    theme: ThemeData(hintColor: Colors.lightGreen, primaryColor: Colors.white),
  ));
}
...
Widget buildTextField(String label, String prefix, TextEditingController textEditing, Function f) {
  return  TextField(
